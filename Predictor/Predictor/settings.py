...
SECRET_KEY = 'django-insecure-n4bq6#!dd(@_73*znkxrq45g(^lkn^ly^q3rzjppj!z(wsmg%@'
...
STATIC_URL = '/static/'
if DEBUG:
    STATIC_ROOT = os.path.join(os.path.dirname(BASE_DIR), "Predictor", "static", "static-only")
    STATICFILES_DIRS = (os.path.join(os.path.dirname(BASE_DIR), "Predictor", "static", "static"),)
...
ACCOUNT_LOGOUT_REDIRECT_URL = '/predictor/'
